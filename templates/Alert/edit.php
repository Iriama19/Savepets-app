          ...
          <ol>
            <aside class="column">
                ...
                <?= $this->Html->link(__('Listar'), ['action' => 'index'], ['class' => 'side-nav-item']) ?> /
                    <?= $this->Form->postLink(__('Eliminar'), ['action' => 'delete', $alert->id], ['confirm' => __('Estas seguro que quieres borrar la alerta {0}?', $alert->title), 'class' => 'side-nav-item']) ?>                 </div>
            </aside>
          </ol>
        </div>
          ...
          <?= $this->Form->create($alert,['class'=>'php-email-form p-3 p-md-4']) ?>
            ...
            <div class="row">
                <div class="alertform-group">
                    ...
                    echo $this->Form->control('active',['class'=>'form-control','label'=> __('Activo'),'options'=>$opcionesActivate]); 
                    ?>
                </div>
            </div>
            <?php 
